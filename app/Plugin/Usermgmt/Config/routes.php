...
Router::connect('/loginMo', array('plugin' => 'usermgmt', 'controller' => 'users', 'action' => 'loginMo'));
...
Router::connect('/forgotPasswordMovil', array('plugin' => 'usermgmt', 'controller' => 'users', 'action' => 'forgotPasswordMovil'));
...
Router::connect('/changeUserPasswordMovil/*', array('plugin' => 'usermgmt', 'controller' => 'users', 'action' => 'changeUserPasswordMovil'));
...
Router::connect('/addPushToken/*', array('plugin' => 'usermgmt', 'controller' => 'users', 'action' => 'addPushToken'));
