	...
	<div class="um_box_mid">
		<div class="um_box_mid_content">
			...
			<div>
					...
					<?php echo $this->Form->input("vendedor_id" ,array('type' => 'select', 'label' => false,'div' => false,'class'=>"form-control" , 'options' => $vendedores))?>
					</div>
						
					<div class="form-group input-group" >
						<span class="input-group-addon"><i class="fa fa-user"></i></span>
						
						<?php echo $this->Form->input("codigos" ,array('type' => 'text', 'label' => false,'div' => false,'class'=>"form-control" , "id" => "codigos"))?>		
					</div>	
					</div>
					<div>
					...
					<div>
						<div class="form-group input-group" >
						<span class="input-group-addon"><i class="fa fa-user"></i></span><?php echo $this->Form->input("password" ,array("type"=>"password",'label' => false,'div' => false,'class'=>"form-control" , 'placeholder' => 'Contraseña'))?></div>
						
					</div>
					<div>
						<div class="form-group input-group" >
						<span class="input-group-addon"><i class="fa fa-user"></i></span><?php echo $this->Form->input("cpassword" ,array("type"=>"password",'label' => false,'div' => false,'class'=>"form-control" , 'placeholder' => 'Repita Contraseña' ))?></div>
