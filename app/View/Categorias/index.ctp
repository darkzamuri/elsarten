...
<div class="categorias index table table-bordered table-hover">
	<h2><?php echo __('Categorias'); ?></h2>
	<table cellpadding="0" cellspacing="0">
	<thead>
	<tr>
			<th><?php echo $this->Paginator->sort('id'); ?></th>
			<th><?php echo $this->Paginator->sort('cot_cat'); ?></th>
			<th><?php echo $this->Paginator->sort('cat_des'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($categoria['Categoria']['cot_cat']); ?>&nbsp;</td>
		<td><?php echo h($categoria['Categoria']['cat_des']); ?>&nbsp;</td>
		<td class="actions">
